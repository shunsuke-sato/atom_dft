...
set output "Cu_wavefunctions.eps"
set title "Wavefunction [Cu]"
set yrange [*:*]
...
set output "Cu_density.eps"
set title "Density [Cu]"
...
set output "Cu_potential.eps"
set title "Potential [Cu]"
