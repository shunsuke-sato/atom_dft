...
set output "Mn_wavefunctions.eps"
set title "Wavefunction [Mn]"
set yrange [*:*]
...
set output "Mn_density.eps"
set title "Density [Mn]"
...
set output "Mn_potential.eps"
set title "Potential [Mn]"
