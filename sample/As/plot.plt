...
set output "As_wavefunctions.eps"
set title "Wavefunction [As]"
set yrange [*:*]
...
set output "As_density.eps"
set title "Density [As]"
...
set output "As_potential.eps"
set title "Potential [As]"
