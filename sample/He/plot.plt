...
set output "He_wavefunctions.eps"
set title "Wavefunction [He]"
set yrange [*:*]
p "results.dat" u ($1*Ba):6 title "1s" w l lt 1 lc 1 lw 2\
,0.0 title "" w l lt 1 lc 7


set output "He_density.eps"
set title "Density [He]"
...
set output "He_potential.eps"
set title "Potential [He]"
