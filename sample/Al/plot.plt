...
set output "Al_wavefunctions.eps"
set title "Wavefunction [Al]"
set yrange [*:*]
...
set output "Al_density.eps"
set title "Density [Al]"
...
set output "Al_potential.eps"
set title "Potential [Al]"
