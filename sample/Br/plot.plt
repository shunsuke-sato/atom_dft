...
set output "Br_wavefunctions.eps"
set title "Wavefunction [Br]"
set yrange [*:*]
...
set output "Br_density.eps"
set title "Density [Br]"
...
set output "Br_potential.eps"
set title "Potential [Br]"
