...
set output "Cl_wavefunctions.eps"
set title "Wavefunction [Cl]"
set yrange [*:*]
...
set output "Cl_density.eps"
set title "Density [Cl]"
...
set output "Cl_potential.eps"
set title "Potential [Cl]"
