...
set output "Se_wavefunctions.eps"
set title "Wavefunction [Se]"
set yrange [*:*]
...
set output "Se_density.eps"
set title "Density [Se]"
...
set output "Se_potential.eps"
set title "Potential [Se]"
