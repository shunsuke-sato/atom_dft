...
set output "Ar_wavefunctions.eps"
set title "Wavefunction [Ar]"
set yrange [*:*]
...
set output "Ar_density.eps"
set title "Density [Ar]"
...
set output "Ar_potential.eps"
set title "Potential [Ar]"
