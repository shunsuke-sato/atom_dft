...
set output "Sc_wavefunctions.eps"
set title "Wavefunction [Sc]"
set yrange [*:*]
...
set output "Sc_density.eps"
set title "Density [Sc]"
...
set output "Sc_potential.eps"
set title "Potential [Sc]"
