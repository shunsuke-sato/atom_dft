...
set output "Cr_wavefunctions.eps"
set title "Wavefunction [Cr]"
set yrange [*:*]
...
set output "Cr_density.eps"
set title "Density [Cr]"
...
set output "Cr_potential.eps"
set title "Potential [Cr]"
