...
set output "Ni_wavefunctions.eps"
set title "Wavefunction [Ni]"
set yrange [*:*]
...
set output "Ni_density.eps"
set title "Density [Ni]"
...
set output "Ni_potential.eps"
set title "Potential [Ni]"
