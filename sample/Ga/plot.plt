...
set output "Ga_wavefunctions.eps"
set title "Wavefunction [Ga]"
set yrange [*:*]
...
set output "Ga_density.eps"
set title "Density [Ga]"
...
set output "Ga_potential.eps"
set title "Potential [Ga]"
