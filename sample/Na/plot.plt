...
set output "Na_wavefunctions.eps"
set title "Wavefunction [Na]"
set yrange [*:*]
...
set output "Na_density.eps"
set title "Density [Na]"
...
set output "Na_potential.eps"
set title "Potential [Na]"
