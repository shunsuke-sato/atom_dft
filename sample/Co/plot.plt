...
set output "Co_wavefunctions.eps"
set title "Wavefunction [Co]"
set yrange [*:*]
...
set output "Co_density.eps"
set title "Density [Co]"
...
set output "Co_potential.eps"
set title "Potential [Co]"
