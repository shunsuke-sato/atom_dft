...
set output "Ca_wavefunctions.eps"
set title "Wavefunction [Ca]"
set yrange [*:*]
...
set output "Ca_density.eps"
set title "Density [Ca]"
...
set output "Ca_potential.eps"
set title "Potential [Ca]"
