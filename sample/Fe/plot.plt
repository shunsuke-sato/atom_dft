...
set output "Fe_wavefunctions.eps"
set title "Wavefunction [Fe]"
set yrange [*:*]
...
set output "Fe_density.eps"
set title "Density [Fe]"
...
set output "Fe_potential.eps"
set title "Potential [Fe]"
