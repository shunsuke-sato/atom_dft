...
set output "Li_wavefunctions.eps"
set title "Wavefunction [Li]"
set yrange [*:*]
...
set output "Li_density.eps"
set title "Density [Li]"
...
set output "Li_potential.eps"
set title "Potential [Li]"
