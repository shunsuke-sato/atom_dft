...
set output "Zn_wavefunctions.eps"
set title "Wavefunction [Zn]"
set yrange [*:*]
...
set output "Zn_density.eps"
set title "Density [Zn]"
...
set output "Zn_potential.eps"
set title "Potential [Zn]"
