...
set output "Mg_wavefunctions.eps"
set title "Wavefunction [Mg]"
set yrange [*:*]
...
set output "Mg_density.eps"
set title "Density [Mg]"
...
set output "Mg_potential.eps"
set title "Potential [Mg]"
