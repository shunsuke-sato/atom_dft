...
set output "Ti_wavefunctions.eps"
set title "Wavefunction [Ti]"
set yrange [*:*]
...
set output "Ti_density.eps"
set title "Density [Ti]"
...
set output "Ti_potential.eps"
set title "Potential [Ti]"
