...
set output "Kr_wavefunctions.eps"
set title "Wavefunction [Kr]"
set yrange [*:*]
...
set output "Kr_density.eps"
set title "Density [Kr]"
...
set output "Kr_potential.eps"
set title "Potential [Kr]"
